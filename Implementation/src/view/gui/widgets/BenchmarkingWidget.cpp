            ...
            namespace widgets
            {
                ...
                void BenchmarkingWidget::initGraph()
                {
                   // ui->plotTimeWidget->setOpenGl(true)
                    ...
                    ui->plotTimeWidget->xAxis->setRange(0, 2000);
                    ui->plotTimeWidget->yAxis->setRange(0, 100);
                    ...
                    ui->plotFPSWidget->xAxis->setRange(0, 2000);
                    ui->plotFPSWidget->yAxis->setRange(0, 100);
                }
